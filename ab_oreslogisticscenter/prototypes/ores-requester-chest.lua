...
data:extend({
    {
        ...
        inventory_size = 48,
        max_health = 350,
        minable = {hardness = 0.5, mining_time = 1, result = entity_names.ores_requester_chest},
...
data:extend({
    {
        ...
        energy_required = 1,
        ingredients = {},
        result = entity_names.ores_requester_chest
    }
})
...
data:extend({
    {
        ...
        subgroup = "logistics",
        order = "l[a]",
        place_result = entity_names.ores_requester_chest,
    }
})
