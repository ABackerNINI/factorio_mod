...
local function make_tech(index, icon, unit)
    local prerequisites = {}
    if index ~= 1 then
        prerequisites = {names.tech_power_consumption .. '-' .. (index * 10 - 19)}
    end
    ...
    data:extend(
        {
            {
                type = 'technology',
                name = names.tech_power_consumption .. '-' .. (index * 10 - 9),
                icon = icon,
                icon_size = 128,
                enable = true,
                upgrade = true,
...
make_tech(1, LC .. '/graphics/technology/power-consumption.png', unit_1)
make_tech(2, LC .. '/graphics/technology/power-consumption.png', unit_2)
make_tech(3, LC .. '/graphics/technology/power-consumption.png', unit_3)
make_tech(4, LC .. '/graphics/technology/power-consumption.png', unit_4)
